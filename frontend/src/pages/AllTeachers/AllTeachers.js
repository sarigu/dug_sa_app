...
const AllTeachers = ({
  load_teachers, teachers, load_teacher_details, totalTeacherPages, load_rejected_teachers, rejectedTeachers, totalRejectedTeacherPages,
}) => {
            ...
            : sortByRejected && rejectedTeachers && rejectedTeachers.length > 0
              ? (
                <>
                  ...
                  <p>
                    {' '}
                    {index <= totalRejectedTeacherPages && index > 0 ? index : index <= 0 ? 1 : totalRejectedTeacherPages}
                  </p>
